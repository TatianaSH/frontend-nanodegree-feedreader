...
The jasmine tests were updated based on course requirements. The tests will run automatically on opening the web page: http://tatianash.github.io/frontend-nanodegree-feedreader
